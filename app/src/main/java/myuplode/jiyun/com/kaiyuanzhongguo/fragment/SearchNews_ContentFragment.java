...
public class SearchNews_ContentFragment extends Fragment implements Xml2Json {
    ...
    public String getInpuStream(String url, String content, String pageIndex, String pageSize) {
        ...
        search_interface.getContent("news", content, pageIndex, pageSize).enqueue(new Callback<ResponseBody>() {
            @Override
